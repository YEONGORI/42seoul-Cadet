...
typedef struct t_stack
{
    ...
    int cur_pos;    // 각 요소의 스택에 대한 현재 위치
    int target_pos; // 각 요소가 올바르게 정렬되기 위해 도달해야하는 위치로 요소들을 스택 A의
    int cost_a;     // 각각의 요소를 a스택의 top
    int cost_b;     // 각각의 요소를 b스택의 top으로 이동하는데드는 비용
} s_stack;
